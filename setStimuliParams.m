...
% preDuration = inputCheck('Input Pre-Stimuli Time.', 0:0.01:10);
% restDuration = inputCheck('Input Resting Duration.', 0:0.01:10);
% postDuration = inputCheck('Input Post-Stimuli Time.', 0:0.01:10);
